...
function CreateBuildsPage() {
  ...
  const [buildDescription, sethBuildDescription] = useState("");
  ...
  const handleBuildDescription = (e: React.ChangeEvent<HTMLInputElement>) => {
    sethBuildDescription(e.target.value);
  };
      ...
      case 2: {
        return (
          <>
            ...
            <div className="mt-6">
              Which
              <span className="text-customSecondary"> Class </span>
              is your Build for?
            </div>
            ...
            <div className="flex gap-4 mt-6">
              {[
                ...
                <div
                  key={item + index}
                  className="duration-200 ease-in hover:text-customSecondary cursor-pointer"
                >
                  {item}
                </div>
              ))}
